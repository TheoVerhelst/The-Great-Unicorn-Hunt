...
t = urllib.request.urlopen(
    'https://maps.googleapis.com/maps/api/directions/json?origin=40.67999267578125,-73.964202880859375&destination=40.655403137207031,-73.959808349609375&key={0}'
    .format(googleApi)).read()
data = json.loads(t)
...
def getFastestRoute(pickupLong, pickupLat, dropoffLong, dropoffLat):
    url = 'https://maps.googleapis.com/maps/api/directions/json?origin={0},{1}&destination={2},{3}&key={4}'.format(
        pickupLat, pickupLong, dropoffLat, dropoffLong, googleApi)
